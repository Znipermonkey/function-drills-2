...
// CODE HERE
const function1 = (parameter1, parameter2) => console.log(`The first parameter is ${parameter1}. The second parameter is ${parameter2}.`)

// INVOKE THE FUNCTION HERE. THE PARAMETERS TAKE ANY DATATYPE.
function1('hello', 'goodye')
...
function pricesPlusTax(priceArr, callback){
    ...
    for(let i = 0; i < priceArr.length; i++){
        totalCost.push(priceArr[i] + priceArr[i] * 0.2)
